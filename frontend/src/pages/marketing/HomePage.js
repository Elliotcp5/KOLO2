...
const HomeContent = () => {
  ...
  return (
    <>
      ...
      <section className="mkt-hero mkt-hero-center" data-testid="mkt-home-hero">
        <div className="mkt-container">
          <motion.div
            className="mkt-hero-center-inner"
            initial="hidden"
            animate="show"
            variants={stagger}
          >
      ...
      {/* ========== PROMISE / PILLARS ========== */}
      <section className="mkt-section mkt-section-alt" data-testid="mkt-promise">
        <div className="mkt-container">
          <motion.div
          ...
          <motion.div
            ...
            variants={stagger}
          >
            <motion.div variants={fadeUp} className="mkt-pillar" data-testid="mkt-pillar-pige">
            ...
            <motion.div variants={fadeUp} className="mkt-pillar" data-testid="mkt-pillar-dictee">
            ...
            <motion.div variants={fadeUp} className="mkt-pillar" data-testid="mkt-pillar-pilotage">
      ...
      {/* ========== STEPS (text-only, single column) ========== */}
      <section className="mkt-section">
        <div className="mkt-container mkt-container-narrow">
          <motion.div
            className="mkt-step-simple"
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: '-80px' }}
            transition={{ duration: 0.7, ease: easeOut }}
          >
            ...
            <h2 className="mkt-h2">{t('home.step1_title_p1')} <span className="mkt-h1-accent">{t('home.step1_title_em')}</span></h2>
          ...
          >
            ...
            <h2 className="mkt-h2">{t('home.step2_title_p1')} <span className="mkt-h1-accent">{t('home.step2_title_em')}</span></h2>
