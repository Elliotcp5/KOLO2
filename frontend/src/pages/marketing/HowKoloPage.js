...
const HowContent = () => {
  ...
  return (
    <>
      <section className="mkt-hero mkt-hero-center" data-testid="mkt-how-hero">
      ...
      <section className="mkt-section-tight">
        <div className="mkt-container mkt-container-narrow">
          {steps.map((s, idx) => (
            <div key={idx} className="mkt-step-simple" data-testid={`mkt-how-step-${idx + 1}`}>
              <div className="mkt-step-num">{s.num}</div>

              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 14 }}>
                <span className="mkt-tag mkt-tag-before" data-testid="mkt-tag-before">
                  <X size={12} style={{ display: 'inline', marginRight: 4, marginBottom: -1 }} strokeWidth={3} />
                  {s.before}
                </span>
                <span className="mkt-tag mkt-tag-after" data-testid="mkt-tag-after">
