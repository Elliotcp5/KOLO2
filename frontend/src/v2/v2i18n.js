...
const STRINGS = {
  fr: {
    ...
    'home.ask_kolo': 'Demander à KOLO',
    'home.today': "Aujourd'hui",
    'home.add_reminder': '+ Rappel',
    'home.add_note': '+ Note',
    'home.reminders': 'Rappels',
    'home.notes': 'Notes',
    'home.done': 'faits',
    'home.processed': 'traitées',
    'home.all_done': 'Tout est fait',
    'home.up_to_date': 'À jour',
    'home.pending_short': '{n} restants',
    'home.to_process': '{n} à traiter',
    'home.recent_cases': 'Dossiers récents',
    'home.see_all': 'Voir tout',
    'home.no_cases': 'Aucun dossier pour l\'instant',
    'home.first_case_hint': 'Crée ton premier dossier depuis l\'onglet « Dossiers ».',
    'home.tip_hello': 'Salut {name} !',
    'home.tip_default': 'Salut {name} ! Bienvenue dans l\'aventure KOLO.',
    'home.upgrade_pro': 'Passer PRO',
    'home.daily_advice': 'Conseil du jour',
    ...
    // Drawer
    'drawer.features': 'Fonctionnalités',
    'drawer.prospecting': 'Pige & Prospection',
    'drawer.referral': 'Parrainage',
    'drawer.guide': 'Guide KOLO',
    'drawer.guide_web': 'Guide complet (web)',
    'drawer.account': 'Compte',
    'drawer.profile': 'Profil & paramètres',
    'drawer.contact': 'Contact / Assistance',
    'drawer.logout': 'Se déconnecter',
    'drawer.legal': 'Informations légales',
    'drawer.privacy': 'Politique de confidentialité',
    'drawer.terms': 'Conditions générales d\'utilisation',
    'drawer.legal_notice': 'Mentions légales',
    'drawer.iap_terms': 'Conditions d\'achat in-app',
    'drawer.delete_account': 'Supprimer mon compte',
    'drawer.upgrade_pro': 'Passer Pro · 24,90€/mois',
    'drawer.support_subject': 'Demande d\'assistance KOLO',
  ...
  en: {
    ...
    'home.notes': 'Notes',
    'home.done': 'done',
    'home.processed': 'processed',
    'home.all_done': 'All done',
    'home.up_to_date': 'Up to date',
    'home.pending_short': '{n} left',
    'home.to_process': '{n} to process',
    'home.recent_cases': 'Recent cases',
    'home.see_all': 'See all',
    'home.no_cases': 'No cases yet',
    'home.first_case_hint': 'Create your first case from the "Cases" tab.',
    'home.tip_hello': 'Hi {name}!',
    'home.tip_default': 'Hi {name}! Welcome to the KOLO journey.',
    'home.upgrade_pro': 'Go PRO',
    'home.daily_advice': 'Tip of the day',
    ...
    'drawer.prospecting': 'Prospecting & Listings',
    'drawer.referral': 'Referral program',
    'drawer.guide': 'KOLO Guide',
    'drawer.guide_web': 'Full guide (web)',
    'drawer.account': 'Account',
    'drawer.profile': 'Profile & settings',
    'drawer.contact': 'Contact / Support',
    'drawer.logout': 'Sign out',
    'drawer.legal': 'Legal',
    'drawer.privacy': 'Privacy policy',
    'drawer.terms': 'Terms of use',
    'drawer.legal_notice': 'Legal notice',
    'drawer.iap_terms': 'In-app purchase terms',
    'drawer.delete_account': 'Delete my account',
    'drawer.upgrade_pro': 'Go Pro · €24.90/month',
    'drawer.support_subject': 'KOLO support request',
  ...
  it: {
    ...
    'home.ask_kolo': 'KOLO fragen',
    'home.today': 'Oggi',
    'home.add_reminder': '+ Promemoria',
    'home.add_note': '+ Nota',
    'home.reminders': 'Promemoria',
    'home.notes': 'Note',
    'home.done': 'fatti',
    'home.processed': 'gestite',
    'home.all_done': 'Tutto fatto',
    'home.up_to_date': 'Aggiornato',
    'home.pending_short': '{n} rimasti',
    'home.to_process': '{n} da gestire',
    'home.recent_cases': 'Pratiche recenti',
    'home.see_all': 'Vedi tutto',
    'home.no_cases': 'Ancora nessuna pratica',
    'home.first_case_hint': 'Crea la tua prima pratica dalla scheda "Pratiche".',
    'home.tip_hello': 'Ciao {name}!',
    'home.tip_default': 'Ciao {name}! Benvenuto nell\'avventura KOLO.',
    'home.upgrade_pro': 'Passa a PRO',
    'home.daily_advice': 'Consiglio del giorno',
    ...
    // Drawer
    'drawer.features': 'Funzionalità',
    'drawer.prospecting': 'Prospezione & Annunci',
    'drawer.referral': 'Programma referral',
    'drawer.guide': 'Guida KOLO',
    'drawer.guide_web': 'Guida completa (web)',
    'drawer.account': 'Account',
    'drawer.profile': 'Profilo & impostazioni',
    'drawer.contact': 'Contatti / Assistenza',
    'drawer.logout': 'Esci',
    'drawer.legal': 'Note legali',
    'drawer.privacy': 'Informativa sulla privacy',
    'drawer.terms': 'Termini d\'uso',
    'drawer.legal_notice': 'Note legali',
    'drawer.iap_terms': 'Termini di acquisto in-app',
    'drawer.delete_account': 'Elimina il mio account',
    'drawer.upgrade_pro': 'Passa a Pro · 24,90€/mese',
    'drawer.support_subject': 'Richiesta di assistenza KOLO',
  ...
  de: {
    ...
    'home.ask_kolo': 'Chiedi a KOLO',
    'home.today': 'Heute',
    'home.add_reminder': '+ Erinnerung',
    'home.add_note': '+ Notiz',
    'home.reminders': 'Erinnerungen',
    'home.notes': 'Notizen',
    'home.done': 'erledigt',
    'home.processed': 'bearbeitet',
    'home.all_done': 'Alles erledigt',
    'home.up_to_date': 'Aktuell',
    'home.pending_short': '{n} offen',
    'home.to_process': '{n} zu bearbeiten',
    'home.recent_cases': 'Letzte Akten',
    'home.see_all': 'Alle anzeigen',
    'home.no_cases': 'Noch keine Akten',
    'home.first_case_hint': 'Lege deine erste Akte über den Tab „Akten" an.',
    'home.tip_hello': 'Hallo {name}!',
    'home.tip_default': 'Hallo {name}! Willkommen bei KOLO.',
    'home.upgrade_pro': 'Auf PRO wechseln',
    'home.daily_advice': 'Tipp des Tages',
    ...
    // Drawer
    'drawer.features': 'Funktionen',
    'drawer.prospecting': 'Akquise & Angebote',
    'drawer.referral': 'Empfehlungsprogramm',
    'drawer.guide': 'KOLO Anleitung',
    'drawer.guide_web': 'Vollständige Anleitung (Web)',
    'drawer.account': 'Konto',
    'drawer.profile': 'Profil & Einstellungen',
    'drawer.contact': 'Kontakt / Support',
    'drawer.logout': 'Abmelden',
    'drawer.legal': 'Rechtliches',
    'drawer.privacy': 'Datenschutzerklärung',
    'drawer.terms': 'Nutzungsbedingungen',
    'drawer.legal_notice': 'Impressum',
    'drawer.iap_terms': 'AGB für In-App-Käufe',
    'drawer.delete_account': 'Konto löschen',
    'drawer.upgrade_pro': 'Pro werden · 24,90€/Monat',
    'drawer.support_subject': 'KOLO Support-Anfrage',
  ...
  es: {
    ...
    'home.ask_kolo': 'Preguntar a KOLO',
    'home.today': 'Hoy',
    'home.add_reminder': '+ Recordatorio',
    'home.add_note': '+ Nota',
    'home.reminders': 'Recordatorios',
    'home.notes': 'Notas',
    'home.done': 'hechos',
    'home.processed': 'procesadas',
    'home.all_done': 'Todo hecho',
    'home.up_to_date': 'Al día',
    'home.pending_short': '{n} restantes',
    'home.to_process': '{n} por procesar',
    'home.recent_cases': 'Expedientes recientes',
    'home.see_all': 'Ver todo',
    'home.no_cases': 'Aún no hay expedientes',
    'home.first_case_hint': 'Crea tu primer expediente desde la pestaña "Expedientes".',
    'home.tip_hello': '¡Hola {name}!',
    'home.tip_default': '¡Hola {name}! Bienvenido a KOLO.',
    'home.upgrade_pro': 'Pasar a PRO',
    'home.daily_advice': 'Consejo del día',
    ...
    // Drawer
    'drawer.features': 'Funcionalidades',
    'drawer.prospecting': 'Prospección & Anuncios',
    'drawer.referral': 'Programa de referidos',
    'drawer.guide': 'Guía KOLO',
    'drawer.guide_web': 'Guía completa (web)',
    'drawer.account': 'Cuenta',
    'drawer.profile': 'Perfil y ajustes',
    'drawer.contact': 'Contacto / Ayuda',
    'drawer.logout': 'Cerrar sesión',
    'drawer.legal': 'Legal',
    'drawer.privacy': 'Política de privacidad',
    'drawer.terms': 'Términos de uso',
    'drawer.legal_notice': 'Aviso legal',
    'drawer.iap_terms': 'Términos de compra in-app',
    'drawer.delete_account': 'Eliminar mi cuenta',
    'drawer.upgrade_pro': 'Pasa a Pro · 24,90€/mes',
    'drawer.support_subject': 'Solicitud de asistencia KOLO',
